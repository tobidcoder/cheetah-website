...
export default function Page() {
  ...
  useEffect(() => {
    const parseHtml = (body: any) => {
      ...
      const elements = Array.from(doc.body.childNodes).map(
        (node: any, index) => {
          return (
            <div
              key={index}
              ...
              <div className={classes.body}>
                ...
                <Group wrap="nowrap" gap="xs">
                  <Group gap="xs" wrap="nowrap">
                    <Avatar size={20} src={blog.created_by_profile_image} />
          ...
          <Box my="xl" py="xl">
            ...
            <Group>
              <div className="Demo__some-network">
                <FacebookShareButton
                  title={blog.title}
                  hashtag="#cheetah #cheetahPos #pos #pointofsales #inventory #quickcommerce #grocerystore #store #cheetahinventory #cheetahpos #localmarket"
                  url={shareUrl}
...
>>>>>>> f90b8504cb7b113bec71ac8d9580755c9689ed81
            ...
            <Group wrap="nowrap" gap="xs">
              <Group gap="xs" wrap="nowrap">
                <Avatar size={60} src={blog.created_by_profile_image} />
                <Box>
                  <Text size="xs">{blog.created_by}</Text>
